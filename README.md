...
- **Ken Lowe** (KenLowe) - Documenting and reverse engineering the Computech Integra-B board: the rebuilt IBOS 1.20 User Guide and the board schematic that Beebium's Integra-B emulation is built from
