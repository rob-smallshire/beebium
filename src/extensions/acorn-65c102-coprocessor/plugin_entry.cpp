...
// Plugin entry point for the Acorn 65C102 4 MHz second processor. It reuses the
// shared SecondProcessor65C02Extension from the acorn-65c02-coprocessor static
// library, constructed with the 65C102's 2/1 clock ratio and identity: the two
// processors are software-identical and differ only in clock and name.
