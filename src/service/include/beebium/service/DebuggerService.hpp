...
public:
    explicit Debugger6502ServiceImpl(MachineType& machine);
    ~Debugger6502ServiceImpl() override = default;
...
//////////////////////////////////////////////////////////////////////////////
// Debugger6502ServiceImpl template implementation
//////////////////////////////////////////////////////////////////////////////

template<typename MachineType>
Debugger6502ServiceImpl<MachineType>::Debugger6502ServiceImpl(MachineType& machine)
    : machine_(machine) {
}

template<typename MachineType>
grpc::Status Debugger6502ServiceImpl<MachineType>::ReadRegisters(
    grpc::ServerContext* /*context*/,
    const Empty* /*request*/,
...
template<typename MachineType>
grpc::Status Debugger6502ServiceImpl<MachineType>::WriteRegisters(
    grpc::ServerContext* /*context*/,
    const WriteRegisters6502Request* request,
